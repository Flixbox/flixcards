export default {
    decks: {
        '78fc4543-371b-4361-a0fa-b06034e62383': {
            name: 'React',
            cards: {
                'bc82999b-1918-4480-9fa0-778b7ebc17b9': {
                    question: 'What are the building blocks of a React-powered UI?',
                    answer: 'Components',
                },
                'c6008de7-7d21-4df9-9735-663695043e64': {
                    question:
        ...
        '22d90dca-dd68-4cd7-8296-8f44de5af079': {
            name: 'React Native',
            cards: {
                '8bba7485-75e2-440f-82d1-76c02984be27': {
                ...
                'd5291b42-d630-4c63-8fb7-61b43b54e81b': {
